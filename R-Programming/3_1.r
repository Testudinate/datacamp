...
into a fixed number of rows and columns. Since you are only working with rows and columns, a matrix is called two-dimensional.
...
In the matrix() function:
    ...
    The argument byrow indicates that the matrix is filled by the rows. If we want the matrix
...
#matrix(c(1, 2, 3, 4, 5, 6, 7, 8, 9),byrow = FALSE,nrow = 3)
matrix(1:9, byrow = TRUE, nrow = 3)
