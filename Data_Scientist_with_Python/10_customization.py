...
It's time to customize your own plot. 
This is the fun part, you will see your plot come to life!
...
ylabel() and title() functions, available in matplotlib.pyplot. This sub-package is already imported as plt.
