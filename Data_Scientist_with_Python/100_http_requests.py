...
of your own. In this interactive exercise, you will ping our very own DataCamp
servers to perform a GET request to extract information from our teach page, "http://www.datacamp.com/teach/documentation".
...
100xp
    ...
    Package the request to the url "http://www.datacamp.com/teach/documentation"
